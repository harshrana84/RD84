    ...
    <div className='w-full'>
      ...
      <div className="flex items-center">
        <button
          ...
          className="flex items-center bg-kesari text-white p-2 rounded-full hover:bg-orange-800 transition-all"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#ffffff" className="bi bi-bag-plus" viewBox="0 0 16 16">
