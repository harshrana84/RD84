 ...
 */}
      ...
      <section aria-labelledby="policies-heading" className="my-8">
        <h2 id="policies-heading" className="sr-only">Our Policies</h2>

        <dl className="grid grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4">
          <div className="rounded-lg border border-base-200 bg-gray-800 p-6 text-center">
            <dt>
              <svg className="mx-auto h-6 w-6 flex-shrink-0 text-base-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
              ...
              <span className="mt-4 text-sm font-medium text-base-900">International delivery</span>
            </dt>
            <dd className="mt-1 text-sm text-base-500">Get your order in 4-6 Days</dd>
          </div>
          ...
          <div className="rounded-lg border border-base-200 bg-gray-800 p-6 text-center">
            <dt>
              ...
              <span className="mt-4 text-sm font-medium text-base-900">Loyalty rewards</span>
            </dt>
            <dd className="mt-1 text-sm text-base-500">Don&apos;t look at other tees</dd>
          </div>
